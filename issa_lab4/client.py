...
############################### EXERCISE 1 ###############################
        ...
        while True:
            ...
            if len(message) == 11:
                ...
                if color == "02550":
                    ...
                    state = True
                if led_number == "01":
                    self.set_dtc1_state(state)
                elif led_number == "02":
                    self.set_dtc2_state(state)
                elif led_number == "03":
                    self.set_dtc3_state(state)
                elif led_number == "04":
                    self.set_dtc4_state(state)
            else:
                led_number = message[4:6]
                state = message[-1:]
                if led_number == "01":
                    self.set_led0_label(state)
                elif led_number == "02":
                    self.set_led1_label(state)
                elif led_number == "03":
                    self.set_led2_label(state)
                elif led_number == "04":
                    self.set_led3_label(state)
    ...
    def diag(self):
        global diag_mode_flag
        diag_mode_flag = True
        self.s.send("0x3E01".encode())
        self.diagMode.setEnabled(False)
...
############################### EXERCISE 4 ###############################
    ...
    def set_led0_flags(self):
        global led0_flag, diag_mode_flag
        if diag_mode_flag:
            message = "0x2E01" + str(int(led0_flag))
            self.s.send(message.encode())
    ...
    def set_led1_flags(self):
        global led1_flag, diag_mode_flag
        if diag_mode_flag:
            message = "0x2E02" + str(int(led1_flag))
            self.s.send(message.encode())
    ...
    def set_led2_flags(self):
        global led2_flag, diag_mode_flag
        if diag_mode_flag:
            message = "0x2E03" + str(int(led2_flag))
            self.s.send(message.encode())
    ...
    def set_led3_flags(self):
        global led3_flag, diag_mode_flag
        if diag_mode_flag:
            message = "0x2E04" + str(int(led3_flag))
            self.s.send(message.encode())
